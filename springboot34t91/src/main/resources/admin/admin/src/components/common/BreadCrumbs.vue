<template>
  <el-breadcrumb class="app-breadcrumb" separator="웃❤유" style="height:50px;backgroundColor:rgba(255, 255, 255, 1);borderRadius:0px;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px #f903d4;borderWidth:2px;borderStyle:dashed none dashed none ;borderColor:rgba(36, 194, 205, 1);">
